...
class CardPaymentDetails {
  ...
  factory CardPaymentDetails.fromJson(Map<String, dynamic> json) {
    return CardPaymentDetails (
      ...
      errors: json['errors'] != null
        ? (json['errors'] as List).map((item) => SquareError.fromJson(item)).toList()
        : null,
      status: json['status'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (applicationCryptogram != null) body['application_cryptogram'] = applicationCryptogram;
    if (applicationIdentifier != null) body['application_identifier'] = applicationIdentifier;
    ...
    if (entryMethod != null) body['entry_method'] = getStringFromTenderCardDetailsEntryMethod(entryMethod);
    if (errors != null) body['errors'] = errors.map((item) => item.toJson()).toList();
    if (status != null) body['status'] = getStringFromTenderCardDetailsStatus(status);
...
class BalancePaymentDetails {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (status != null) body['status'] = getStringFromBalancePaymentStatus(status);
