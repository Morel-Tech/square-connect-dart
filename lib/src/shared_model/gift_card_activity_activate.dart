...
part 'gift_card_activity_activate.g.dart';

@JsonSerializable()
class GiftCardActivityActivate extends Equatable {
  const GiftCardActivityActivate({
    this.amountMoney,
  ...
  /// Converts a [Map]<[String], [dynamic]> to a [GiftCardActivityActivate]
  factory GiftCardActivityActivate.fromJson(Map<String, dynamic> json) =>
      _$GiftCardActivityActivateFromJson(json);

  /// Converts a [GiftCardActivityActivate] to a [Map]<[String], [dynamic]>
