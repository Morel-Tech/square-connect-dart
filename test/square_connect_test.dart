...
void main() {
      ...
      group('Search Customer Method', () {
        test(
          ...
          var item = await squareClient.customersApi.searchCustomers(
              ...
              createdAtStart: DateTime(2019, 1, 1),
              createdAtEnd: DateTime(2019, 6, 30));
  ...
  group('Catalog API', () {
    ...
    group('retrieveCatalogObject', () {
      ...
      test(
          'returns a RetrieveCatalogObjectResponse if the http call completes successfully',
          () async {
        final squareClient = SquareConnect.instance;
        final httpClient = MockClient();
        squareClient.setClient(client: httpClient);
        ...
        when(httpClient.get(
                'https://connect.squareup.com/v2/catalog/object/fake-item-id',
                headers: {'Authorization': 'Bearer fake-token'}))
            .thenAnswer((_) async => Response(response, 200));

        var item = await squareClient.catalogApi
            .retrieveCatalogObject(objectId: 'fake-item-id');
      ...
      group('related objects', () {
        test('if related objects is true, then returns related objects',
            () async {
          final squareClient = SquareConnect.instance;
          final httpClient = MockClient();
          squareClient.setClient(client: httpClient);
          ...
          when(httpClient.get(
              'https://connect.squareup.com/v2/catalog/object/fake-item-id?include_related_objects=true',
              headers: {
                'Authorization': 'Bearer fake-token'
              })).thenAnswer((_) async => Response(response, 200));
          ...
          expect(
              (await squareClient.catalogApi.retrieveCatalogObject(
                      objectId: 'fake-item-id', includeRelatedObjects: true))
                  .relatedObjects,
              isInstanceOf<List<CatalogObject>>());
        });

        test(
            'if related objects is false, then doesn'
            't return related objects', () async {
          final squareClient = SquareConnect.instance;
          final httpClient = MockClient();
          squareClient.setClient(client: httpClient);
          squareClient.setAuthToken(token: 'fake-token');
          ...
          when(httpClient.get(
              'https://connect.squareup.com/v2/catalog/object/fake-item-id?include_related_objects=false',
              headers: {
                'Authorization': 'Bearer fake-token'
              })).thenAnswer((_) async => Response(response, 200));
          ...
          expect(
              (await squareClient.catalogApi.retrieveCatalogObject(
                      objectId: 'fake-item-id', includeRelatedObjects: false))
                  .relatedObjects,
              null);
        });
      });
    ...
    group('listCatalogObject', () {
      test(
          'returns a ListCatalogResponse if the http call completes successfully',
          () async {
        final squareClient = SquareConnect.instance;
        final httpClient = MockClient();
        squareClient.setClient(client: httpClient);
      ...
      test(
          'returns a ListCatalogResponse with errors if the http call completes unsuccesfully',
          () async {
        final squareClient = SquareConnect.instance;
        final httpClient = MockClient();
        squareClient.setClient(client: httpClient);
        ...
        const response =
            '{"errors":[{"category":"INVALID_REQUEST_ERROR","code":"INVALID_CURSOR","detail":"The provided cursor `FakeCursor` was not found.","field":"cursor"}]}';
    ...
    group('deleteCatalogObject', () {
      test(
          'returns a DeleteCatalogObjectResponse if the http call completes successfully',
          () async {
        final squareClient = SquareConnect.instance;
        final httpClient = MockClient();
        squareClient.setClient(client: httpClient);
        ...
        const response =
            '{"deleted_object_ids":["DDXGG2X5FKZJYNJ5WCWN2K5F","XPEYCWZOSOME722PNDPH3VBV"],"deleted_at":"2019-07-03T23:45:21.465Z"}';

        when(httpClient.delete(
                'https://connect.squareup.com/v2/catalog/object/fake-object-id',
                headers: {'Authorization': 'Bearer fake-token'}))
            .thenAnswer((_) async => Response(response, 200));

        var item = await squareClient.catalogApi
            .deleteCatalogObject(objectId: 'fake-object-id');
      ...
      test(
          'returns a DeleteCatalogObjectResponse with errors if the http call completes unsuccesfully',
          () async {
        final squareClient = SquareConnect.instance;
        final httpClient = MockClient();
        squareClient.setClient(client: httpClient);
        ...
        const response =
            '{"errors":[{"category":"INVALID_REQUEST_ERROR","code":"NOT_FOUND","detail":"Catalog object with ID `XPEYCWZOSOME722PNDPH3VBV` not found."}]}';
